...
<header id="masthead" class="site-header">
    ...
    <div class="breadcrumb">
        ...
        <a href="#">技术分享</a>
        <i class="iconfont icon-chevronright">  </i>
        <a href="<?php echo url('/list',['cid'=>encrypt($cate_id)]); ?>"><?php echo htmlspecialchars($cate_name); ?></a>
    </div>
    <div id="content">
